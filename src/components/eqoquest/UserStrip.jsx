...
export default function UserStrip({ userScore, gapToNextRank, pendingClaims, onViewFullLeaderboard, onClaimPending }) {
  return (
    <Card className="sticky top-14 lg:top-0 z-10 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl p-4 mb-6 shadow-lg border-2" style={{ borderColor: 'var(--color-primary)' }}>
