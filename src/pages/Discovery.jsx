          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            ...
            <div className="flex gap-2 flex-wrap">
              <Link to={createPageUrl("Privacy")}>
                <Button className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 min-h-[44px]">
                  <Shield className="w-5 h-5 mr-2" />
                  Find Confidential Connections
                </Button>
              </Link>
              <Link to={createPageUrl("Privacy")}>
                <Button variant="outline" className="border-purple-500/30 text-purple-400 hover:bg-purple-500/10 min-h-[44px]">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              size="sm"
              onClick={loadUsers}
              className="border-purple-500/30 text-purple-400 hover:bg-purple-500/10 min-h-[44px]">
                    ...
                    <Button
                      ...
                      {hoveredBubble.user.username && (
                        <Link to={createPageUrl('PublicProfile') + `?username=${encodeURIComponent(hoveredBubble.user.username)}`} className="flex-1">
                          <Button variant="outline" className="w-full border-purple-500/30 text-white hover:bg-purple-500/10 min-h-[44px]">
