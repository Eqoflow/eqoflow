  ...
  try {
    ...
    return Response.json({
      gifs: data.data.map(gif => ({
        id: gif.id,
        title: gif.title,
        url: gif.images.downsized_medium?.url || gif.images.downsized?.url || gif.images.original.url,
        preview: gif.images.fixed_height.url,
        width: gif.images.downsized_medium?.width || gif.images.original.width,
        height: gif.images.downsized_medium?.height || gif.images.original.height
      })),
